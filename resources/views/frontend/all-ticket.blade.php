                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="width: 30% !important;"><a href="{{ route('frontend.assign-ticket-to-user', $ticketdata['ticket_id']) }}" class="text-primary flex flex-nowrap" title="{{$ticketdata['subject']}}"> {{ $ticketdata['subject'] }}</a></td>
                        <td>
