...
<form class="login-form">
    ...
    <div class="mb-30">
        <div class="form-group mb-0">
            ...
            <input type="email" wire:model.defer="email" id="email" placeholder="{{ __('Email') }}">
        </div>
    ...
    <div class="mb-30">
        <div class="form-group mb-0">
            <label for="name"><i class="fas fa-phone-alt"></i></label>
            <input type="number" wire:model.defer="phone"  placeholder="{{ __('Mobile') }}">
        </div>
